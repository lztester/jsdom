...
function patchGlobalFunctionDeclaration(globalDeclaration) {
  const { parents } = globalDeclaration;
    ...
    case "LabeledStatement":
	  {
        ...
        const outermostLabeledStatement = parents[i + 1];
        outermostLabeledStatement.id = globalDeclaration.id;
        outermostLabeledStatement.parents = globalDeclaration.parents.slice(0, i + 2);
        patchGlobalFunctionDeclaration(outermostLabeledStatement);
      }
      break;
    case "WhileStatement":
